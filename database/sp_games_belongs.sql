...
CREATE TABLE `belongs` (
  ...
  KEY `belongs_ibfk_2` (`gameid`),
  CONSTRAINT `belongs_ibfk_1` FOREIGN KEY (`categoryid`) REFERENCES `category` (`id`),
  CONSTRAINT `belongs_ibfk_2` FOREIGN KEY (`gameid`) REFERENCES `game` (`id`)
